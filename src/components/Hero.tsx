...
const Hero = () => {
  return (
    <section className="relative min-h-screen bg-symage-dark overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-72 h-72 bg-symage-primary/10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-symage-secondary/10 rounded-full blur-3xl"></div>
      ...
      <div className="relative container mx-auto px-6 py-20 min-h-screen flex items-center">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="animate-scale-in flex flex-col sm:flex-row gap-4 justify-center mb-16" style={{ animationDelay: '0.4s', animationFillMode: 'both' }}>
            <Button size="lg" className="bg-symage-primary hover:bg-symage-primary/90 text-white text-lg px-8 py-4 h-auto">
              Claim Free Proof-of-Concept Dataset
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <Button variant="outline" size="lg" className="border-symage-primary text-symage-primary hover:bg-symage-primary hover:text-white text-lg px-8 py-4 h-auto">
              Learn More
            </Button>
          </div>
          ...
          <div className="animate-fade-in grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto" style={{ animationDelay: '0.6s', animationFillMode: 'both' }}>
            <div className="flex flex-col items-center p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
              <Target className="h-8 w-8 mb-3 text-symage-primary" />
            ...
            <div className="flex flex-col items-center p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
              <Zap className="h-8 w-8 mb-3 text-symage-accent" />
            ...
            <div className="flex flex-col items-center p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
              <Eye className="h-8 w-8 mb-3 text-symage-secondary" />

      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="text-center p-8 bg-red-50 rounded-2xl border border-red-100 animate-slide-in-left">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-red-100 rounded-full mb-6">
                <AlertTriangle className="h-8 w-8 text-red-600" />
              </div>
              <div className="text-4xl font-bold text-red-600 mb-2">30%</div>
              <p className="text-gray-700 font-medium">Error rate in manual inspection</p>
            </div>
            
            <div className="text-center p-8 bg-orange-50 rounded-2xl border border-orange-100 animate-scale-in" style={{ animationDelay: '0.1s', animationFillMode: 'both' }}>
              <div className="inline-flex items-center justify-center w-16 h-16 bg-orange-100 rounded-full mb-6">
                <DollarSign className="h-8 w-8 text-orange-600" />
              </div>
              <div className="text-4xl font-bold text-orange-600 mb-2">$1.3T</div>
              <p className="text-gray-700 font-medium">Global annual losses to poor quality</p>
            </div>
            
            <div className="text-center p-8 bg-yellow-50 rounded-2xl border border-yellow-100 animate-slide-in-left" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
              <div className="inline-flex items-center justify-center w-16 h-16 bg-yellow-100 rounded-full mb-6">
                <TrendingDown className="h-8 w-8 text-yellow-600" />
              </div>
              <div className="text-4xl font-bold text-yellow-600 mb-2">30/100</div>
              <p className="text-gray-700 font-medium">Potentially flawed products approved</p>
            </div>
          </div>
          
          {/* Main Content */}
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl p-8 md:p-12 animate-fade-in">
          ...
          <div className="mt-20 text-center animate-fade-in">
            ...
            <div className="bg-white border border-gray-200 rounded-3xl p-8 md:p-12 shadow-lg max-w-4xl mx-auto">
              <p className="text-lg text-gray-700 leading-relaxed">

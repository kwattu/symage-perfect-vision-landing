        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-20 animate-fade-in">
            ...
            <p className="text-2xl text-symage-medium-gray max-w-4xl mx-auto leading-relaxed">
              ...
              <span className="font-semibold text-red-600"> direct assault</span> on your bottom line and brand reputation.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            <div className="group relative text-center p-10 bg-white rounded-3xl border border-gray-200 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-4 animate-slide-in-left overflow-hidden">
              ...
              <div className="inline-flex items-center justify-center w-20 h-20 bg-red-100 rounded-2xl mb-8 group-hover:scale-110 transition-transform duration-300">
                <AlertTriangle className="h-10 w-10 text-red-600" />
              </div>
              <div className="text-5xl font-bold text-red-600 mb-4 font-sans">30%</div>
            ...
            <div className="group relative text-center p-10 bg-white rounded-3xl border border-gray-200 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-4 animate-scale-in overflow-hidden" style={{ animationDelay: '0.1s', animationFillMode: 'both' }}>
              ...
              <div className="inline-flex items-center justify-center w-20 h-20 bg-orange-100 rounded-2xl mb-8 group-hover:scale-110 transition-transform duration-300">
                <DollarSign className="h-10 w-10 text-orange-600" />
              </div>
              <div className="text-5xl font-bold text-orange-600 mb-4 font-sans">$1.3T</div>
            ...
            <div className="group relative text-center p-10 bg-white rounded-3xl border border-gray-200 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-4 animate-slide-in-left overflow-hidden" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
              ...
              <div className="inline-flex items-center justify-center w-20 h-20 bg-yellow-100 rounded-2xl mb-8 group-hover:scale-110 transition-transform duration-300">
                <TrendingDown className="h-10 w-10 text-yellow-600" />
              </div>
              <div className="text-5xl font-bold text-yellow-600 mb-4 font-sans">30/100</div>
          ...
          <div className="relative bg-white rounded-3xl p-12 md:p-16 shadow-xl border border-gray-200 animate-fade-in overflow-hidden">
            ...
            <div className="relative max-w-4xl mx-auto">
              ...
              <p className="text-xl text-symage-medium-gray mb-8 leading-relaxed">
                ...
                <span className="font-bold text-red-600"> 30%</span>. This means for every 100 products approved, up to 
                <span className="font-bold text-red-600"> 30 could be flawed</span>—leading to staggering waste, costly rework, and eroded customer trust.
              </p>
              <p className="text-xl text-symage-medium-gray leading-relaxed">
                Globally, manufacturers lose an estimated 
                <span className="font-bold text-orange-600"> $1.3 trillion annually</span> to poor quality. This isn't just a number; it's the market share you lose and the damage to the reputation you've worked so hard to build.
              </p>
            </div>
          </div>
          ...
          <div className="mt-24 text-center animate-fade-in">
            <h3 className="text-4xl md:text-5xl font-bold text-symage-text-dark mb-12 font-sans leading-tight">
              ...
              <span className="block text-transparent bg-gradient-to-r from-red-600 via-orange-600 to-red-700 bg-clip-text">
                It's Your Data.
              </span>
            </h3>
            <div className="relative bg-white border border-gray-200 rounded-3xl p-12 md:p-16 shadow-xl max-w-5xl mx-auto overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-xl text-symage-medium-gray leading-relaxed">
                  ...
                  <span className="font-semibold text-red-600"> bottleneck</span>—it's expensive to acquire, slow to label, and riddled with inconsistencies and blind spots. Training your models on 
                  <span className="font-semibold text-orange-600"> imperfect data</span> creates a critical gap between their potential and their actual performance, leaving you vulnerable to missed defects.
                </p>
              </div>
            </div>
          </div>
